...
public class SharePrefUtil {
    ...
    /**
     * store the cookie from response in the SharedPreferences when login success
     *
     * @param headers the header array from response
/*     *//*
    public static void storeCookie(Header[] headers) {
     ...
     *            modified:
     */
    public static void saveObject(final String key, final Object obj) {
